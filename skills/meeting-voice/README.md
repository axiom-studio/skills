...
```bash
docker build -f skills/meeting-voice/Dockerfile -t axiomstudio/skill-meeting-voice:0.2.0 .
docker run --rm -e MEET_AUDIO_SMOKE=1 axiomstudio/skill-meeting-voice:0.2.0
docker run --rm -e MEET_BROWSER_SMOKE=1 axiomstudio/skill-meeting-voice:0.2.0
```
